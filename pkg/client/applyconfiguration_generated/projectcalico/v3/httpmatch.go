...
type HTTPMatchApplyConfiguration struct {
	...
	Headers []HTTPHeaderCriteriaApplyConfiguration `json:"headers,omitempty"`
}
...
func (b *HTTPMatchApplyConfiguration) WithHeaders(values ...*HTTPHeaderCriteriaApplyConfiguration) *HTTPMatchApplyConfiguration {
	for i := range values {
		if values[i] == nil {
