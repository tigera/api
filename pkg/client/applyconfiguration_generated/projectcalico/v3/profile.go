...
// apply.
func Profile(name string) *ProfileApplyConfiguration {
...
func ExtractProfileFrom(profile *projectcalicov3.Profile, fieldManager string, subresource string) (*ProfileApplyConfiguration, error) {
	b := &ProfileApplyConfiguration{}
	err := managedfields.ExtractInto(profile, internal.Parser().Type("com.github.tigera.api.pkg.apis.projectcalico.v3.Profile"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractProfile(profile *projectcalicov3.Profile, fieldManager string) (*ProfileApplyConfiguration, error) {
