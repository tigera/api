...
type ControllersConfigApplyConfiguration struct {
	...
	FederatedServices *FederatedServicesControllerConfigApplyConfiguration `json:"federatedServices,omitempty"`
...
// WithFederatedServices sets the FederatedServices field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the FederatedServices field is set to the value of the last call.
func (b *ControllersConfigApplyConfiguration) WithFederatedServices(value *FederatedServicesControllerConfigApplyConfiguration) *ControllersConfigApplyConfiguration {
	b.FederatedServices = value
	return b
}
