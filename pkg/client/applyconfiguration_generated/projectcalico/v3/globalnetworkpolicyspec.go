...
// GlobalNetworkPolicySpecApplyConfiguration represents a declarative configuration of the GlobalNetworkPolicySpec type for use
// with apply.
type GlobalNetworkPolicySpecApplyConfiguration struct {
...
// GlobalNetworkPolicySpecApplyConfiguration constructs a declarative configuration of the GlobalNetworkPolicySpec type for use with
// apply.
func GlobalNetworkPolicySpec() *GlobalNetworkPolicySpecApplyConfiguration {
	return &GlobalNetworkPolicySpecApplyConfiguration{}
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithTier(value string) *GlobalNetworkPolicySpecApplyConfiguration {
	b.Tier = &value
	return b
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithOrder(value float64) *GlobalNetworkPolicySpecApplyConfiguration {
	b.Order = &value
	return b
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithIngress(values ...*RuleApplyConfiguration) *GlobalNetworkPolicySpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithEgress(values ...*RuleApplyConfiguration) *GlobalNetworkPolicySpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithSelector(value string) *GlobalNetworkPolicySpecApplyConfiguration {
	b.Selector = &value
	return b
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithTypes(values ...projectcalicov3.PolicyType) *GlobalNetworkPolicySpecApplyConfiguration {
	for i := range values {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithDoNotTrack(value bool) *GlobalNetworkPolicySpecApplyConfiguration {
	b.DoNotTrack = &value
	return b
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithPreDNAT(value bool) *GlobalNetworkPolicySpecApplyConfiguration {
	b.PreDNAT = &value
	return b
}
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithApplyOnForward(value bool) *GlobalNetworkPolicySpecApplyConfiguration {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithServiceAccountSelector(value string) *GlobalNetworkPolicySpecApplyConfiguration {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithNamespaceSelector(value string) *GlobalNetworkPolicySpecApplyConfiguration {
...
func (b *GlobalNetworkPolicySpecApplyConfiguration) WithPerformanceHints(values ...projectcalicov3.PolicyPerformanceHint) *GlobalNetworkPolicySpecApplyConfiguration {
	for i := range values {
