...
type GlobalAlertInformer interface {
	...
	Lister() projectcalico.GlobalAlertLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectcalicoProjectcalico().GlobalAlerts().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectcalicoProjectcalico().GlobalAlerts().Watch(context.TODO(), options)
			},
		},
		&apisprojectcalico.GlobalAlert{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *globalAlertInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprojectcalico.GlobalAlert{}, f.defaultInformer)
}

func (f *globalAlertInformer) Lister() projectcalico.GlobalAlertLister {
	return projectcalico.NewGlobalAlertLister(f.Informer().GetIndexer())
}
