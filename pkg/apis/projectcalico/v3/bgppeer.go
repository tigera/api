...
type BGPPeerSpec struct {
	...
	FailureDetectionMode FailureDetectionMode `json:"failureDetectionMode,omitempty"`
	...
	RestartMode RestartMode `json:"restartMode,omitempty"`
	...
	BIRDGatewayMode BIRDGatewayMode `json:"birdGatewayMode,omitempty"`
...
// +kubebuilder:validation:Enum=None;BFDIfDirectlyConnected
...
// +kubebuilder:validation:Enum=GracefulRestart;LongLivedGracefulRestart
...
// +kubebuilder:validation:Enum=Recursive;DirectIfDirectlyConnected
