...
func (b *NetworkPolicySpecApplyConfiguration) WithTier(value string) *NetworkPolicySpecApplyConfiguration {
	b.Tier = &value
	return b
}
...
func (b *NetworkPolicySpecApplyConfiguration) WithOrder(value float64) *NetworkPolicySpecApplyConfiguration {
	b.Order = &value
	return b
}
...
func (b *NetworkPolicySpecApplyConfiguration) WithIngress(values ...*RuleApplyConfiguration) *NetworkPolicySpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *NetworkPolicySpecApplyConfiguration) WithEgress(values ...*RuleApplyConfiguration) *NetworkPolicySpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *NetworkPolicySpecApplyConfiguration) WithSelector(value string) *NetworkPolicySpecApplyConfiguration {
	b.Selector = &value
	return b
}
...
func (b *NetworkPolicySpecApplyConfiguration) WithTypes(values ...projectcalicov3.PolicyType) *NetworkPolicySpecApplyConfiguration {
	for i := range values {
...
func (b *NetworkPolicySpecApplyConfiguration) WithServiceAccountSelector(value string) *NetworkPolicySpecApplyConfiguration {
...
func (b *NetworkPolicySpecApplyConfiguration) WithPerformanceHints(values ...projectcalicov3.PolicyPerformanceHint) *NetworkPolicySpecApplyConfiguration {
	for i := range values {
