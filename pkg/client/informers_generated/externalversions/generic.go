...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v3.SchemeGroupVersion.WithResource("alertexceptions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().AlertExceptions().Informer()}, nil
	...
	case v3.SchemeGroupVersion.WithResource("deeppacketinspections"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().DeepPacketInspections().Informer()}, nil
	case v3.SchemeGroupVersion.WithResource("egressgatewaypolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().EgressGatewayPolicies().Informer()}, nil
	case v3.SchemeGroupVersion.WithResource("externalnetworks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().ExternalNetworks().Informer()}, nil
	...
	case v3.SchemeGroupVersion.WithResource("networks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().Networks().Informer()}, nil
	...
	case v3.SchemeGroupVersion.WithResource("policyrecommendationscopes"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().PolicyRecommendationScopes().Informer()}, nil
	...
	case v3.SchemeGroupVersion.WithResource("securityeventwebhooks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().SecurityEventWebhooks().Informer()}, nil
	...
	case v3.SchemeGroupVersion.WithResource("uisettings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Projectcalico().V3().UISettings().Informer()}, nil
