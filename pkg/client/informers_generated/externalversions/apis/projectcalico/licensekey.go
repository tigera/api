...
type LicenseKeyInformer interface {
	...
	Lister() projectcalico.LicenseKeyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectcalicoProjectcalico().LicenseKeys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectcalicoProjectcalico().LicenseKeys(namespace).Watch(context.TODO(), options)
			},
		},
		&apisprojectcalico.LicenseKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *licenseKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisprojectcalico.LicenseKey{}, f.defaultInformer)
}

func (f *licenseKeyInformer) Lister() projectcalico.LicenseKeyLister {
	return projectcalico.NewLicenseKeyLister(f.Informer().GetIndexer())
}
