...
func (c *egressGatewayPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.EgressGatewayPolicy, err error) {
	result = &v3.EgressGatewayPolicy{}
	err = c.client.Get().
		Resource("egressgatewaypolicies").
		Name(name).
...
func (c *egressGatewayPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v3.EgressGatewayPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v3.EgressGatewayPolicyList{}
	err = c.client.Get().
		Resource("egressgatewaypolicies").
...
func (c *egressGatewayPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *egressGatewayPolicies) Create(ctx context.Context, egressGatewayPolicy *v3.EgressGatewayPolicy, opts v1.CreateOptions) (result *v3.EgressGatewayPolicy, err error) {
	result = &v3.EgressGatewayPolicy{}
	err = c.client.Post().
		Resource("egressgatewaypolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(egressGatewayPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *egressGatewayPolicies) Update(ctx context.Context, egressGatewayPolicy *v3.EgressGatewayPolicy, opts v1.UpdateOptions) (result *v3.EgressGatewayPolicy, err error) {
	result = &v3.EgressGatewayPolicy{}
	err = c.client.Put().
		Resource("egressgatewaypolicies").
		Name(egressGatewayPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(egressGatewayPolicy).
		Do(ctx).
		Into(result)
...
func (c *egressGatewayPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *egressGatewayPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *egressGatewayPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.EgressGatewayPolicy, err error) {
	result = &v3.EgressGatewayPolicy{}
