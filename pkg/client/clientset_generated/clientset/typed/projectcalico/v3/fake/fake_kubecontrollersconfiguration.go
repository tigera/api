...
func (c *FakeKubeControllersConfigurations) Get(name string, options v1.GetOptions) (result *v3.KubeControllersConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeControllersConfigurations) List(opts v1.ListOptions) (result *v3.KubeControllersConfigurationList, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeControllersConfigurations) Create(kubeControllersConfiguration *v3.KubeControllersConfiguration) (result *v3.KubeControllersConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeControllersConfigurations) Update(kubeControllersConfiguration *v3.KubeControllersConfiguration) (result *v3.KubeControllersConfiguration, err error) {
	obj, err := c.Fake.
...
func (c *FakeKubeControllersConfigurations) UpdateStatus(kubeControllersConfiguration *v3.KubeControllersConfiguration) (*v3.KubeControllersConfiguration, error) {
	obj, err := c.Fake.
...
func (c *FakeKubeControllersConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3.KubeControllersConfiguration, err error) {
	obj, err := c.Fake.
