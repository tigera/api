...
type ExternalNetwork struct {
	...
	Spec              ExternalNetworkSpec `json:"spec" protobuf:"bytes,2,opt,name=spec"`
}
...
// New ExternalNetwork creates a new (zeroed) ExternalNetwork struct with the TypeMetadata
