...
func ExtractIPPoolFrom(iPPool *projectcalicov3.IPPool, fieldManager string, subresource string) (*IPPoolApplyConfiguration, error) {
	b := &IPPoolApplyConfiguration{}
	err := managedfields.ExtractInto(iPPool, internal.Parser().Type("com.github.tigera.api.pkg.apis.projectcalico.v3.IPPool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractIPPool(iPPool *projectcalicov3.IPPool, fieldManager string) (*IPPoolApplyConfiguration, error) {
...
func ExtractIPPoolStatus(iPPool *projectcalicov3.IPPool, fieldManager string) (*IPPoolApplyConfiguration, error) {
