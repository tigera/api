...
type BGPPeerSpecApplyConfiguration struct {
	...
	FailureDetectionMode *projectcalicov3.FailureDetectionMode `json:"failureDetectionMode,omitempty"`
	...
	RestartMode *projectcalicov3.RestartMode `json:"restartMode,omitempty"`
	...
	BIRDGatewayMode *projectcalicov3.BIRDGatewayMode `json:"birdGatewayMode,omitempty"`
...
func (b *BGPPeerSpecApplyConfiguration) WithExtensions(entries map[string]string) *BGPPeerSpecApplyConfiguration {
...
// WithFailureDetectionMode sets the FailureDetectionMode field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the FailureDetectionMode field is set to the value of the last call.
func (b *BGPPeerSpecApplyConfiguration) WithFailureDetectionMode(value projectcalicov3.FailureDetectionMode) *BGPPeerSpecApplyConfiguration {
	b.FailureDetectionMode = &value
	return b
}

// WithRestartMode sets the RestartMode field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the RestartMode field is set to the value of the last call.
func (b *BGPPeerSpecApplyConfiguration) WithRestartMode(value projectcalicov3.RestartMode) *BGPPeerSpecApplyConfiguration {
	b.RestartMode = &value
	return b
}
...
// WithBIRDGatewayMode sets the BIRDGatewayMode field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the BIRDGatewayMode field is set to the value of the last call.
func (b *BGPPeerSpecApplyConfiguration) WithBIRDGatewayMode(value projectcalicov3.BIRDGatewayMode) *BGPPeerSpecApplyConfiguration {
	b.BIRDGatewayMode = &value
	return b
}
