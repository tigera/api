...
func (c *FakeGlobalReportTypes) Get(name string, options v1.GetOptions) (result *v3.GlobalReportType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(globalreporttypesResource, c.ns, name), &v3.GlobalReportType{})
...
func (c *FakeGlobalReportTypes) List(opts v1.ListOptions) (result *v3.GlobalReportTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(globalreporttypesResource, globalreporttypesKind, c.ns, opts), &v3.GlobalReportTypeList{})
...
func (c *FakeGlobalReportTypes) Create(globalReportType *v3.GlobalReportType) (result *v3.GlobalReportType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(globalreporttypesResource, c.ns, globalReportType), &v3.GlobalReportType{})
...
func (c *FakeGlobalReportTypes) Update(globalReportType *v3.GlobalReportType) (result *v3.GlobalReportType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(globalreporttypesResource, c.ns, globalReportType), &v3.GlobalReportType{})
...
func (c *FakeGlobalReportTypes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(globalreporttypesResource, c.ns, name), &v3.GlobalReportType{})
