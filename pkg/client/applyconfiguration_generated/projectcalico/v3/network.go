...
func ExtractNetworkFrom(network *projectcalicov3.Network, fieldManager string, subresource string) (*NetworkApplyConfiguration, error) {
	b := &NetworkApplyConfiguration{}
	err := managedfields.ExtractInto(network, internal.Parser().Type("com.github.tigera.api.pkg.apis.projectcalico.v3.Network"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractNetwork(network *projectcalicov3.Network, fieldManager string) (*NetworkApplyConfiguration, error) {
...
func ExtractNetworkStatus(network *projectcalicov3.Network, fieldManager string) (*NetworkApplyConfiguration, error) {
