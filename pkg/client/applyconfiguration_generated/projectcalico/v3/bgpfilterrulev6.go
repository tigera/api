...
func (b *BGPFilterRuleV6ApplyConfiguration) WithPeerType(value projectcalicov3.BGPFilterPeerType) *BGPFilterRuleV6ApplyConfiguration {
	b.PeerType = &value
	return b
}
...
func (b *BGPFilterRuleV6ApplyConfiguration) WithCommunities(value *BGPFilterCommunityMatchApplyConfiguration) *BGPFilterRuleV6ApplyConfiguration {
	b.Communities = value
	return b
}
...
func (b *BGPFilterRuleV6ApplyConfiguration) WithASPathPrefix(values ...numorstring.ASNumber) *BGPFilterRuleV6ApplyConfiguration {
	for i := range values {
...
func (b *BGPFilterRuleV6ApplyConfiguration) WithPriority(value int) *BGPFilterRuleV6ApplyConfiguration {
	b.Priority = &value
	return b
}
...
func (b *BGPFilterRuleV6ApplyConfiguration) WithOperations(values ...*BGPFilterOperationApplyConfiguration) *BGPFilterRuleV6ApplyConfiguration {
	for i := range values {
		if values[i] == nil {
