...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalAlertTemplateSpec) DeepCopyInto(out *GlobalAlertTemplateSpec) {
	*out = *in
	if in.Period != nil {
		in, out := &in.Period, &out.Period
		*out = new(v1.Duration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalAlertTemplateSpec.
func (in *GlobalAlertTemplateSpec) DeepCopy() *GlobalAlertTemplateSpec {
	if in == nil {
		return nil
	}
	out := new(GlobalAlertTemplateSpec)
	in.DeepCopyInto(out)
	return out
}
