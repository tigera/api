...
# Patch the fake Calico client to return a fake.RESTClient instead of nil. This
# prevents flakes in tests where a background goroutine tries to use the REST
# client. Enterprise-only; not present in the OSS script.
git apply -p2 < "${REPO_ROOT}/return-fake-rest-client.patch"
