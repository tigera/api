...
type ExternalNetworkInterface interface {
	...
	Apply(ctx context.Context, externalNetwork *applyconfigurationgeneratedprojectcalicov3.ExternalNetworkApplyConfiguration, opts v1.ApplyOptions) (result *projectcalicov3.ExternalNetwork, err error)
	ExternalNetworkExpansion
}

// externalNetworks implements ExternalNetworkInterface
type externalNetworks struct {
	*gentype.ClientWithListAndApply[*projectcalicov3.ExternalNetwork, *projectcalicov3.ExternalNetworkList, *applyconfigurationgeneratedprojectcalicov3.ExternalNetworkApplyConfiguration]
}
...
func newExternalNetworks(c *ProjectcalicoV3Client) *externalNetworks {
	return &externalNetworks{
		gentype.NewClientWithListAndApply[*projectcalicov3.ExternalNetwork, *projectcalicov3.ExternalNetworkList, *applyconfigurationgeneratedprojectcalicov3.ExternalNetworkApplyConfiguration](
			"externalnetworks",
			c.RESTClient(),
