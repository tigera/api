...
type PacketCaptureSpec struct {
	...
	// +optional
	AutoTermination *PacketCaptureAutoTermination `json:"autoTermination,omitempty" validate:"omitempty"`
}
...
type PacketCaptureStatus struct {
	Files []PacketCaptureFile `json:"files,omitempty" validate:"omitempty,dive"`
}
...
type PacketCaptureFile struct {
	...
	// Determines whether a PacketCapture is capturing traffic or not
