...
${BINDIR}/lister-gen "$@" \
	      --go-header-file "${REPO_ROOT}/hack/boilerplate/boilerplate.go.txt" \
	      --input-dirs="github.com/tigera/api/pkg/apis/projectcalico" \
...
${BINDIR}/informer-gen "$@" \
	      ...
	      --input-dirs "github.com/tigera/api/pkg/apis/projectcalico" \
	      --input-dirs "github.com/tigera/api/pkg/apis/projectcalico/v3" \
	      --internal-clientset-package "github.com/tigera/api/pkg/client/clientset_generated/internalclientset" \
